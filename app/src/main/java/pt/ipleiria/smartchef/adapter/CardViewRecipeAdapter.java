...
public class CardViewRecipeAdapter extends RecyclerView
        .Adapter<CardViewRecipeAdapter
        .DataObjectHolder> {
    ...
    public CardViewRecipeAdapter(ArrayList<Recipe> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_recipe_row, parent, false);
